...
public class FlywayConfiguration {
  ...
  public Flyway flywayForJpa() {
    Flyway flyway = Flyway.configure().baselineOnMigrate(Boolean.TRUE).dataSource(this.dataSource)
        .locations("database/migration").load();
    return flyway;
  }
  ...
  @Bean
  public FlywayMigrationInitializer initializeDBs(
      @Qualifier("flywayForShortener") Flyway flywayForShortener) {
